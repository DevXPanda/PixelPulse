              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 bg-gray-50 hover:bg-white"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleStrategyInputChange}
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 bg-gray-50 hover:bg-white resize-none"
...
//       {/* Animated background */}
//       <div className="absolute inset-0 overflow-hidden">
//         <div className="absolute -top-40 -right-40 w-72 sm:w-80 h-72 sm:h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
//         <div className="absolute -bottom-40 -left-40 w-72 sm:w-80 h-72 sm:h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-2000"></div>
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 sm:w-80 h-72 sm:h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-4000"></div>
//       </div>
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.8, delay: 0.3 }}
//             className="font-bold text-white leading-tight mb-4 sm:mb-6 text-[28px] sm:text-4xl md:text-5xl lg:text-6xl"
//           >
//             Grow Your Business with
//             <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
//               High-Converting Ads, SEO & Powerful Websites
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.8, delay: 0.5 }}
//             className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-2"
//           >
//             Transform your online presence with data-driven digital marketing strategies 
//             and cutting-edge web development that drives real results and boosts your revenue.
//           </motion.p>
...
//           >
//             <Button size="lg" className="group w-full sm:w-auto" onClick={() => setShowContactForm(true)}>
//               Get Free Strategy Call
//               <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
//             </Button>

//             <Button variant="outline" size="lg" className="border-white/20 text-white hover:bg-white/10 w-full sm:w-auto" onClick={scrollToPortfolio}>
//               View Our Works
//               <Briefcase className="ml-2 h-5 w-5" />
//             </Button>
//           </motion.div>
...
//           >
//             {[
//               { icon: ChartBar, color: "blue", text: "ROI-Focused Campaigns" },
//               { icon: Code, color: "purple", text: "Custom Web Solutions" },
//               { icon: Briefcase, color: "green", text: "End-to-End Service" },
//             ].map((item, i) => (
//               <div key={i} className="flex flex-col items-center text-center">
//                 <div className={`w-12 h-12 bg-${item.color}-500/20 rounded-lg flex items-center justify-center mb-3`}>
...
//             <motion.div className="bg-white rounded-2xl shadow-2xl max-w-sm sm:max-w-md w-full max-h-[90vh] overflow-y-auto">
//               <div className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-2xl flex justify-between">
//                 <h3 className="text-xl font-bold text-gray-900">Get Free Strategy Call</h3>
...
//                 <textarea rows={4} placeholder="Project Details" className="input" />
